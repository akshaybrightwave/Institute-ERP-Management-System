...
urlpatterns = [
    ...
    path('payment-settings/student/', views.student_payment_setting, name='student_payment_setting'),
    path('payment-settings/center/', views.center_payment_setting, name='center_payment_setting'),
